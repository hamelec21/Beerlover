<div>
    ...
    <div class="ml-auto mb-6 lg:w-[75%] xl:w-[80] 2xl:w-[85%]">
        <div class="container mx-auto bg-gray-800  rounded-lg">
            <h2 class="flex justify-center mt-5 py-3 font-bold text-white">Módulo de Gestion de Comunas</h2>
        </div>
                ...
                <div class="mt-5 flex  bg-gray-100 font-sans overflow-hidden rounded-lg">
                    <div class="w-full">
                        ...
                        <div class="flex justify-around bg-gray-200 items-center  py-3">
                            ...
                            <!--boton de crear-->
                            <div>
                                <a href="{{ route('crear-comuna') }}">
                                    <button class="btn-agregar ">Crear Nueva Comuna</button>
                                </a>
                            </div>
                                    ...
                                    <td class="py-1 px-6 text-center">
                                        <div class="flex item-center justify-center">
                                            ...
                                            <div class="flex items-center justify-around py-[4px]">
                                                <a
                                                    href="{{ route('editar-comuna', ['id' => $comuna->id]) }}">
                                            ...
                                            <div class="mt-1 px-3">
                                                <a onclick="confirm('¿Estas Seguro de Eliminar La Comuna?')||event.stopImmediatePropagation()"
                                                    wire:click="destroy({{ $comuna->id }})"><button
