<div>
    ...
    <div class="ml-auto mb-6 lg:w-[75%] xl:w-[80] 2xl:w-[85%] ">
        ...
        <div class="container mx-auto bg-gray-800  rounded-lg  w-1/2">
            <h2 class="flex justify-center mt-5 py-3 font-bold text-white">Crear Nuevo Comercio</h2>
        </div>
        ...
        <div class="container mx-auto w-1/2 bg-gray-100 px-4 mt-5 rounded-lg">
            <form wire:submit="save">
                ...
                <div class="container mx-auto bg-gray-800  rounded-lg  ">
                    ...
                    <div class="col-span-3">
                        <x-input type="number" placeholder="Ingrese el Comsumo Minimo" class="mt-3 w-full"
                            wire:model="consumo_minimo" />
                        <x-input-error for="consumo_minimo" />
                    </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div><button type="submit" class="btn-agregar mt-10 mb-8 w-full">Guadar Nuevo Comercio</button>
                    </div>
