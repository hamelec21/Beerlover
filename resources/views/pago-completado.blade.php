...
<body class="flex items-center justify-center h-screen bg-green-600">
    <div class="relative flex flex-col items-center w-full px-8">
        ...
        <div class="w-96 h-auto bg-green-200 rounded-lg p-5 text-center">
            <!-- Logo -->
            ...
            <div class="flex justify-center mt-5">
                <img src="{{ asset('img/iconos/positive-payment.png') }}" class="w-20">
            </div>
            <!-- Mensaje -->
            <p class="px-4 text-justify mt-3">
                Tu transacción ha sido completada correctamente. Gracias por tu compra.
            </p>
            <!-- Botón centrado -->
