<div>
    ...
    <div class="container mx-auto px-4 mt-3">
        ...
        <div class="flex flex-wrap justify-around item-center px-2 p-2 bg-gray-100">
            ...
            <div class="flex flex-col w-1/3 text-[14px] px-6">{{ \Carbon\Carbon::parse($this->locales->ham1)->format('H:i') }}</div>
            <div class="flex flex-col w-1/3 text-[14px] px-6">{{ \Carbon\Carbon::parse($this->locales->hpm2)->format('H:i') }}</div>
            <div class="flex flex-col w-1/3 text-[14px] px-6">{{$this->locales->d2}}</div>
            <div class="flex flex-col w-1/3 text-[14px] px-6">{{ \Carbon\Carbon::parse($this->locales->ham3)->format('H:i') }}</div>
            <div class="flex flex-col w-1/3 text-[14px] px-6">{{ \Carbon\Carbon::parse($this->locales->hpm4)->format('H:i') }}</div>
            <div class="flex flex-col w-1/3 text-[14px] px-6">{{$this->locales->d3}}</div>
            <div class="flex flex-col w-1/3 text-[14px] px-6">{{ \Carbon\Carbon::parse($this->locales->ham5)->format('H:i') }}</div>
            <div class="flex flex-col w-1/3 text-[14px] px-6">{{ \Carbon\Carbon::parse($this->locales->hpm6)->format('H:i') }}</div>
            <div class="flex flex-col w-1/3 text-[14px] px-6">{{$this->locales->d4}}</div>
            <div class="flex flex-col w-1/3 text-[14px] px-6">{{ \Carbon\Carbon::parse($this->locales->ham7)->format('H:i') }}</div>
            <div class="flex flex-col w-1/3 text-[14px] px-6">{{ \Carbon\Carbon::parse($this->locales->hpm8)->format('H:i') }}</div>
            <div class="flex flex-col w-1/3 text-[14px] px-6">{{$this->locales->d5}}</div>
            <div class="flex flex-col w-1/3 text-[14px] px-6">{{ \Carbon\Carbon::parse($this->locales->ham9)->format('H:i') }}</div>
            <div class="flex flex-col w-1/3 text-[14px] px-6">{{ \Carbon\Carbon::parse($this->locales->hpm10)->format('H:i') }}</div>
            <div class="flex flex-col w-1/3 text-[14px] px-6">{{$this->locales->d6}}</div>
            <div class="flex flex-col w-1/3 text-[14px] px-6">{{ \Carbon\Carbon::parse($this->locales->ham11)->format('H:i') }}</div>
            <div class="flex flex-col w-1/3 text-[14px] px-6">{{ \Carbon\Carbon::parse($this->locales->hpm12)->format('H:i') }}</div>
            <div class="flex flex-col w-1/3 text-[14px] px-6">{{$this->locales->d7}}</div>
            <div class="flex flex-col w-1/3 text-[14px] px-6">{{ \Carbon\Carbon::parse($this->locales->ham13)->format('H:i') }}</div>
            <div class="flex flex-col w-1/3 text-[14px] px-6">{{ \Carbon\Carbon::parse($this->locales->hpm14)->format('H:i') }}</div>
        </div>
