<div>
    ...
    <div class="ml-auto mb-6 lg:w-[75%] xl:w-[80] 2xl:w-[85%] ">
        ...
        <div class="container mx-auto bg-gray-800  rounded-lg  w-1/2">
            <h2 class="flex justify-center mt-5 py-3 font-bold text-white">Crear Plan</h2>
        </div>
        ...
        <div class="container mx-auto w-1/2 bg-gray-100 px-4 mt-5 rounded-lg">
            <form wire:submit="save">
                <div x-data="{ uploading: false, progress: 0 }" x-on:livewire-upload-start="uploading = true"
                    ...
                    <x-input type="text" placeholder="Nombre Plan Basico" class="mt-10  w-full"
                        wire:model="nombre" />
                    <x-input-error for="nombre" />

                    <div class="mt-5 mb-5 rounded-lg"wire.defer>
                        <textarea wire:model.defer="descripcion" id="editor" placeholder="Descripcion" rows="5"
                        ...
                        <div x-show="uploading" class="mt-4">
                            <div class="relative pt-1">
                                ...
                                <div class="flex mb-2 items-center justify-between">
                                    <div>
                                        <span
                                            class="text-sm font-semibold inline-block py-1 px-2 uppercase rounded-full text-gray-600 bg-gray-200">
                                            Cargando...
                                        </span>
                                    </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div><button type="submit" class="btn-agregar mt-10 mb-8 w-full">Guadar</button>
                    </div>
