<div>
    ...
    <div class="ml-auto mb-6 lg:w-[75%] xl:w-[80] 2xl:w-[85%]">
        <div class="container mx-auto bg-gray-800  rounded-lg">
            <h2 class="flex justify-center mt-5 py-3 font-bold text-white">Módulo de Gestión de meseros</h2>
        </div>
                ...
                <div class="mt-5 flex  bg-gray-100 font-sans overflow-hidden rounded-lg">
                    <div class="w-full">
                        ...
                        <div class="flex justify-around bg-gray-200 items-center  py-3">
                            ...
                            <!--boton de crear-->
                            <div>
                                <a href="{{ route('crear-mesero') }}">
                                    <button class="btn-agregar ">Crear Nueva Mesero</button>
                                </a>
                            </div>
        ...
        <div class="container mx-auto">
            <div class="bg-white shadow-md rounded my-6 ">
                @if ($usuariosMeseros->count())
                    <table class="min-w-max w-full table-auto">
                        ...
                        <tbody class="text-gray-600 text-sm font-light">
                            @foreach ($usuariosMeseros as $mesero)
                                <tr class="border-b border-gray-200 hover:bg-gray-100">
                                    ...
                                    <td class="py-1 px-6 text-center">
                                        <div class="flex items-center font-bold uppercase">
                                            <span>
                                                <img src="{{ $mesero->qr_code }}" class="w-20 h-20">
                                            </span>
                                        </div>
                                    </td>
                                    ...
                                    <td class="py-1 px-6 text-center">
                                        <div class="flex items-center font-bold uppercase ">
                                            <span>{{ $mesero->name }}</span>
                                        </div>
                                    </td>
                                    <td class="py-1 px-6 text-center">
                                        <div class="flex items-center font-bold uppercase ">
                                            <span>{{ $mesero->apellidos }}</span>
                                        </div>
                                    </td>
                                    ...
                                    <td class="py-1 px-6 text-center">
                                        <div class="flex item-center justify-center">
                                            ...
                                            <div class="flex items-center justify-around py-[4px]">
                                                <a
                                                    href="{{ route('editar-mesero', ['id' => $mesero->id]) }}">
                                                    <button class="btn-editar mb-1">Editar</button>
                                                </a>
                                            </div>

                                            <div class="mt-1 px-3">
                                                <a onclick="confirm('¿Estas Seguro de Eliminar el mesero?')||event.stopImmediatePropagation()"
                                                    wire:click="destroy({{ $mesero->id }})"><button
                ...
                <div class="bg-gray-200">
                    @if ($usuariosMeseros->hasPages())
                        <div class="px-6 py-3 ">
                            {{ $usuariosMeseros->links() }}
                        </div>
                    @endif
                </div>
                </div>
